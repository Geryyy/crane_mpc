...
def write_header(
    ...
    lines = [
        ...
        f"#define CRANE_MPC_OCP_PARAMETER_PATH_SPAN {P_PATH_SPAN}",
        f"#define CRANE_MPC_OCP_PARAMETER_TIMING_CONTROL {P_TIMING_CONTROL}",
        f"#define CRANE_MPC_OCP_PARAMETER_TIMING_POINTS {TIMING_POINTS}",
